...
def add_model_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--model-type", type=str, default="_")
...
def add_data_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--anli-round", type=str, default=None)
    group.add_argument("--loss-ratio", type=float, default=None)
    ...
    group.add_argument("--small-dataset", type=int, default=0)

    group.add_argument("--sequence-level-acc", type=list, default=[[],[],[]])
...
def add_ppo_args(parser: argparse.ArgumentParser):
    ...
    # Only temp
    group.add_argument("--temp-sample", type=dict, default={})
...
def add_gen_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--repetition-penalty", type=float, default=1.05)
